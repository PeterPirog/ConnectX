...
if __name__== "__main__":
    states, actions, rewards, next_states, done = sarsFile_2_sarsFeatures('ConnectX_episodes.obj',verbose=True)
    ...
    history=agent.modelEnc.fit(x=x_train,y=y_train,validation_data=(x_val,y_val),
                       batch_size=32,epochs=500,callbacks=[tensorboard_callback])
